...
function Dashboard() {
    ...
    const followUpsLast7Days = last7Days.map((day) =>
        visits.filter((visit) =>
            moment(visit.visit_date).isSame(moment(day, "ddd"), "day") && visit.notes && visit.notes.includes("follow-up")
        ).length
    );

    const visitTypes = {
        inPerson: visits.filter((visit) => !(visit.notes && visit.notes.includes("virtual"))).length,
        virtual: visits.filter((visit) => visit.notes && visit.notes.includes("virtual")).length,
        cancelled: 0,
    };
    ...
    // FIX: Remove stray https:// and invalid JSX opening
    const AdminMarketerDashboard = () => (
        <>
                    ...
                    <Col xs="12" sm="6" lg="3" className="mb-4">
                        <Card className="card-stats">
                                ...
                                <Row>
                                    <Col xs="5" className="d-flex justify-content-center">
                                        <div className="icon-big text-center icon-warning">
                                            <i className="fa fa-chart-pie text-warning" />
                                        </div>
                                    </Col>
                                    <Col xs="7">
                            ...
                            <Card.Footer>
                                <hr />
                                <div className="stats">
                                    <i className="fas fa-redo mr-1" /> Updated now
                                </div>
                            </Card.Footer>
                        </Card>
                    </Col>
                        ...
                        <Card className="card-stats">
                            <Card.Body>
                                <Row>
                                    <Col xs="5" className="d-flex justify-content-center">
                                        <div className="icon-big text-center icon-warning">
                                            <i className="fa fa-user-md text-success" />
                                        </div>
                                    </Col>
                                    <Col xs="7">
                                        <div className="numbers">
                            ...
                            <Card.Footer>
                                <hr />
                                <div className="stats">
                                    <i className="far fa-calendar-alt mr-1" /> Last update
                                </div>
                            </Card.Footer>
                        </Card>
                    </Col>
            ...
            /td> <
            td > Sign contract
            for "What are conference organizers afraid of?" < /td> <
                ...
                overlay = { < Tooltip id = "tooltip-506045838" > Remove.. < /Tooltip>} >
                    ...
                    overlay = { < Tooltip id = "tooltip-537440761" > Edit Task.. < /Tooltip>} >
                        ...
                        overlay = { < Tooltip id = "tooltip-21130535" > Remove.. < /Tooltip>} >
                            ...
                            assessing what was lost and what was found < /td> <
                            td className = "td-actions text-right" >
                            <
                            OverlayTrigger
                            placement = "top"
                                                    ...
                                                    loadingVisits ? ( <
                                                        ...
                                                        tbody > {
                                                            upcomingVisits.map((visit, index) => ( <
                                                                    ...
                                                                    /Form.Check> <
                                                                    /td> <
                                                                    td > { visit.doctor_name } - { visit.location }, { moment(visit.visit_date).format("MMM D, YYYY") } <
                                                                    /td> <
                                                                    td className = "td-actions text-right" >
                                                                    <
                                                                    OverlayTrigger placement = "top"
                                                        ...
                                                        p className = "card-category" > Recent updates
                                                        for you < /p> <
                                                        /Card.Header> <
                                                        Card.Body >
                                                        <
                                                                ...
                                                                /div>
                                                                    ...
                                                                    tbody > {
                                                                        notifications.slice(0, 5).map((notification, index) => ( <
                                                                                ...
                                                                                td className = "td-actions text-right" > {!notification.is_read && ( <
                                                                                        OverlayTrigger placement = "top"
